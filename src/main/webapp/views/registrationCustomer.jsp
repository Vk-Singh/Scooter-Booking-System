...
<div class="container" align="Left">
	<div class ="row" align="center">
		...
		<form action="register" method="post">
			...
			<input type="text" id="licenseNum" class="form-control" id= "licenseNum" name="licenseNum" maxlength="16" required> 	
			</div>
			  
			<div class="form-group">
			<label>Date Of Birth</label>
			<input type="date" id="dob" class="form-control" id= "dob" name="dob" required> 	
			</div>
